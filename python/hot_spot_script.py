...
##Burglaries
burgs_update = r"U:\Mapping\Police\burglaries_daily.shp"
burgs_update_output = "burglaries_daily" + "_" + today_name
##Auto-Thefts
theft_update = r"U:\Mapping\Police\vehicle_thefts_daily.shp"
theft_update_output = "vehicle_thefts_daily" + "_" + today_name
##Robberies
robbery_update = r"U:\Mapping\Police\robberies_daily.shp"
robbery_update_output = "robberies_daily" + "_" + today_name
##Theft from Motor Vehicl
v_theft_update = r"U:\Mapping\Police\thefts_from_vehicle_daily.shp"
...
emerging_list = [Burglary_Emerging_Final, VTheft_Emerging_Final, Robbery_Emerging_Final, Theft_From_Vehicle_Emerging_Final]
...
optimal_list = [Burglary_Optimal_Hot_spot, VTheft_Optimal_Hot_spot, Robbery_Optimal_Hot_spot, Thefts_from_Vehicle_Optimal_Hot_spot]

arcpy.management.Merge(optimal_list, 
                       arcpy.env.workspace + "/Optimal_Hot_SpotsA.shp", 
                       'SOURCE_ID "SOURCE_ID" true true false 10 Long 0 10,First,#,Burglary_Optimal_Hot_spot,SOURCE_ID,-1,-1,VTheft_Optimal_Hot_spot,SOURCE_ID,-1,-1,Robbery_Optimal_Hot_spot,SOURCE_ID,-1,-1,Thefts_from_Vehicle_Optimal_Hot_spot,SOURCE_ID,-1,-1;JOIN_COUNT "JOIN_COUNT" true true false 10 Long 0 10,First,#,Burglary_Optimal_Hot_spot,JOIN_COUNT,-1,-1,VTheft_Optimal_Hot_spot,JOIN_COUNT,-1,-1,Robbery_Optimal_Hot_spot,JOIN_COUNT,-1,-1,Thefts_from_Vehicle_Optimal_Hot_spot,JOIN_COUNT,-1,-1;Shape_Leng "Shape_Leng" true true false 19 Double 0 0,First,#,Burglary_Optimal_Hot_spot,Shape_Leng,-1,-1,VTheft_Optimal_Hot_spot,Shape_Leng,-1,-1,Robbery_Optimal_Hot_spot,Shape_Leng,-1,-1,Thefts_from_Vehicle_Optimal_Hot_spot,Shape_Leng,-1,-1;Shape_Area "Shape_Area" true true false 19 Double 0 0,First,#,Burglary_Optimal_Hot_spot,Shape_Area,-1,-1,VTheft_Optimal_Hot_spot,Shape_Area,-1,-1,Robbery_Optimal_Hot_spot,Shape_Area,-1,-1,Thefts_from_Vehicle_Optimal_Hot_spot,Shape_Area,-1,-1;GiZScore "GiZScore" true true false 19 Double 0 0,First,#,Burglary_Optimal_Hot_spot,GiZScore,-1,-1,VTheft_Optimal_Hot_spot,GiZScore,-1,-1,Robbery_Optimal_Hot_spot,GiZScore,-1,-1,Thefts_from_Vehicle_Optimal_Hot_spot,GiZScore,-1,-1;GiPValue "GiPValue" true true false 19 Double 0 0,First,#,Burglary_Optimal_Hot_spot,GiPValue,-1,-1,VTheft_Optimal_Hot_spot,GiPValue,-1,-1,Robbery_Optimal_Hot_spot,GiPValue,-1,-1,Thefts_from_Vehicle_Optimal_Hot_spot,GiPValue,-1,-1;NNeighbors "NNeighbors" true true false 10 Long 0 10,First,#,Burglary_Optimal_Hot_spot,NNeighbors,-1,-1,VTheft_Optimal_Hot_spot,NNeighbors,-1,-1,Robbery_Optimal_Hot_spot,NNeighbors,-1,-1,Thefts_from_Vehicle_Optimal_Hot_spot,NNeighbors,-1,-1;Gi_Bin "Gi_Bin" true true false 10 Long 0 10,First,#,Burglary_Optimal_Hot_spot,Gi_Bin,-1,-1,VTheft_Optimal_Hot_spot,Gi_Bin,-1,-1,Robbery_Optimal_Hot_spot,Gi_Bin,-1,-1,Thefts_from_Vehicle_Optimal_Hot_spot,Gi_Bin,-1,-1;TYPE "TYPE" true true false 254 Text 0 0,First,#,Burglary_Optimal_Hot_spot,TYPE,0,254,VTheft_Optimal_Hot_spot,TYPE,0,254,Robbery_Optimal_Hot_spot,TYPE,0,254,Thefts_from_Vehicle_Optimal_Hot_spot,TYPE,0,254', "NO_SOURCE_INFO")
...
crime_list = [Robberies, Vehicle_Thefts, Burglaries, Thefts_from_Vehicle]

arcpy.management.Merge(crime_list, 
                       arcpy.env.workspace + "/Crimes.shp", 
                       'IncdntN "IncdntN" true true false 80 Text 0 0,First,#,Robberies,IncdntN,0,80,Vehicle_Thefts,IncdntN,0,80,Burglaries,IncdntN,0,80,Thefts_from_Vehicle,IncdntN,0,80;Priorty "Priorty" true true false 80 Text 0 0,First,#,Robberies,Priorty,0,80,Vehicle_Thefts,Priorty,0,80,Burglaries,Priorty,0,80,Thefts_from_Vehicle,Priorty,0,80;IncdntT "IncdntT" true true false 80 Text 0 0,First,#,Robberies,IncdntT,0,80,Vehicle_Thefts,IncdntT,0,80,Burglaries,IncdntT,0,80,Thefts_from_Vehicle,IncdntT,0,80;Address "Address" true true false 80 Text 0 0,First,#,Robberies,Address,0,80,Vehicle_Thefts,Address,0,80,Burglaries,Address,0,80,Thefts_from_Vehicle,Address,0,80;UntNmbr "UntNmbr" true true false 80 Text 0 0,First,#,Robberies,UntNmbr,0,80,Vehicle_Thefts,UntNmbr,0,80,Burglaries,UntNmbr,0,80,Thefts_from_Vehicle,UntNmbr,0,80;Date "Date" true true false 8 Date 0 0,First,#,Robberies,Date,-1,-1,Vehicle_Thefts,Date,-1,-1,Burglaries,Date,-1,-1,Thefts_from_Vehicle,Date,-1,-1;ArrvlTm "ArrvlTm" true true false 80 Text 0 0,First,#,Robberies,ArrvlTm,0,80,Vehicle_Thefts,ArrvlTm,0,80,Burglaries,ArrvlTm,0,80,Thefts_from_Vehicle,ArrvlTm,0,80;Date2 "Date2" true true false 8 Date 0 0,First,#,Robberies,Date2,-1,-1,Vehicle_Thefts,Date2,-1,-1,Burglaries,Date2,-1,-1,Thefts_from_Vehicle,Date2,-1,-1;Count "Count" true true false 19 Double 15 18,First,#,Robberies,Count,-1,-1,Vehicle_Thefts,Count,-1,-1,Burglaries,Count,-1,-1,Thefts_from_Vehicle,Count,-1,-1;AREA "AREA" true true false 19 Double 15 18,First,#,Robberies,AREA,-1,-1,Vehicle_Thefts,AREA,-1,-1,Burglaries,AREA,-1,-1,Thefts_from_Vehicle,AREA,-1,-1;PERIMET "PERIMET" true true false 19 Double 15 18,First,#,Robberies,PERIMET,-1,-1,Vehicle_Thefts,PERIMET,-1,-1,Burglaries,PERIMET,-1,-1,Thefts_from_Vehicle,PERIMET,-1,-1;CITYBND_ "CITYBND_" true true false 9 Long 0 9,First,#,Robberies,CITYBND_,-1,-1,Vehicle_Thefts,CITYBND_,-1,-1,Burglaries,CITYBND_,-1,-1,Thefts_from_Vehicle,CITYBND_,-1,-1;CITYBND_I "CITYBND_I" true true false 9 Long 0 9,First,#,Robberies,CITYBND_I,-1,-1,Vehicle_Thefts,CITYBND_I,-1,-1,Burglaries,CITYBND_I,-1,-1,Thefts_from_Vehicle,CITYBND_I,-1,-1;CITY "CITY" true true false 80 Text 0 0,First,#,Robberies,CITY,0,80,Vehicle_Thefts,CITY,0,80,Burglaries,CITY,0,80,Thefts_from_Vehicle,CITY,0,80;CITY_ "CITY_" true true false 80 Text 0 0,First,#,Robberies,CITY_,0,80,Vehicle_Thefts,CITY_,0,80,Burglaries,CITY_,0,80,Thefts_from_Vehicle,CITY_,0,80;SYMBOL "SYMBOL" true true false 9 Long 0 9,First,#,Robberies,SYMBOL,-1,-1,Vehicle_Thefts,SYMBOL,-1,-1,Burglaries,SYMBOL,-1,-1,Thefts_from_Vehicle,SYMBOL,-1,-1;ACREAGE "ACREAGE" true true false 19 Double 15 18,First,#,Robberies,ACREAGE,-1,-1,Vehicle_Thefts,ACREAGE,-1,-1,Burglaries,ACREAGE,-1,-1,Thefts_from_Vehicle,ACREAGE,-1,-1;Shp_Lng "Shp_Lng" true true false 19 Double 15 18,First,#,Robberies,Shp_Lng,-1,-1,Vehicle_Thefts,Shp_Lng,-1,-1,Burglaries,Shp_Lng,-1,-1,Thefts_from_Vehicle,Shp_Lng,-1,-1;Shap_Ar "Shap_Ar" true true false 19 Double 15 18,First,#,Robberies,Shap_Ar,-1,-1,Vehicle_Thefts,Shap_Ar,-1,-1,Burglaries,Shap_Ar,-1,-1,Thefts_from_Vehicle,Shap_Ar,-1,-1;Citylbl "Citylbl" true true false 80 Text 0 0,First,#,Robberies,Citylbl,0,80,Vehicle_Thefts,Citylbl,0,80,Burglaries,Citylbl,0,80,Thefts_from_Vehicle,Citylbl,0,80;SqMiles "SqMiles" true true false 19 Double 15 18,First,#,Robberies,SqMiles,-1,-1,Vehicle_Thefts,SqMiles,-1,-1,Burglaries,SqMiles,-1,-1,Thefts_from_Vehicle,SqMiles,-1,-1', "NO_SOURCE_INFO")
